...
function SettingsRow({ icon, label, description, onClick, to, trailing }: SettingsRowProps) {
  const content = (
    <div className="flex items-center gap-3 px-4 py-3.5 hover:bg-gray-50 dark:hover:bg-gray-800/60 transition cursor-pointer">
      ...
      {trailing ?? <ChevronRight size={18} className="text-gray-400" />}
    </div>
  );
...
export default function Settings() {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="mb-6">
        <p className="text-xs font-semibold text-gray-400 uppercase px-1 mb-2">Account</p>
      ...
      <div className="mb-6">
        <p className="text-xs font-semibold text-gray-400 uppercase px-1 mb-2">Preferences</p>
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden divide-y divide-gray-100 dark:divide-gray-800">
          <SettingsRow
            ...
            trailing={
              <div
                className={`w-10 h-5 rounded-full flex items-center px-0.5 transition-colors ${
                  isDark ? 'bg-purple-500 justify-end' : 'bg-gray-300 dark:bg-gray-700 justify-start'
                }`}
              >
      ...
      <div className="mb-6">
        <p className="text-xs font-semibold text-gray-400 uppercase px-1 mb-2">About</p>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 text-red-500 font-semibold py-3 rounded-xl border border-red-200 dark:border-red-900/40 hover:bg-red-50 dark:hover:bg-red-900/10 transition"
      >
