...
import { Home, MessageCircle, Settings as SettingsIcon, Sun, Moon, Search, Plus, Sparkles, LogOut, FileText, Image } from 'lucide-react';
      ...
      <nav className="hidden md:flex flex-col w-64 h-[calc(100vh-32px)] sticky top-4 left-0 glass-card rounded-3xl p-6 border border-white/10 select-none z-30 flex-shrink-0">
        ...
        <div className="border-t border-gray-100 dark:border-white/5 pt-4 space-y-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="flex-1 py-2 glass-card rounded-xl border border-white/5 flex items-center justify-center text-gray-500 hover:text-purple-500 transition cursor-pointer"
